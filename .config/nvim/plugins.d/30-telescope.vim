...
nnoremap <Leader>gw <cmd>lua RELOAD'telescope'; require'telescope.builtin'.grep_string{ shorten_path = true, word_match = "-w", only_sort_text = true }<CR>
nnoremap <Leader>gs <cmd>lua RELOAD'telescope'; require'telescope.builtin'.grep_string{ shorten_path = true, only_sort_text = true, search = vim.fn.input("Grep For >") }<CR>
...
nnoremap <leader>aw <cmd>lua RELOAD'telescope'; require'telescope.builtin'.lsp_workspace_symbols({ query = vim.fn.input("Query >"), shorten_path = true })<CR>
